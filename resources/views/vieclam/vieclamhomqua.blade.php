                    ...
                    <div class="col-sm-12">
                        <div class="clearfix">
                            <ol class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                                ...
                                <li class="active"><span class="text-muted">Việc làm hôm qua</span></li>
                            </ol>
                                ...
                                <div class="row extra-mrg job-list brows-employer-list mrg-bot-10">
                                    <div class="col-sm-9">
                                        <div class="sidebar-widget-title mrg-bot-15">
                                            ...
                                            <h4>Có <b style="color: red">{{count($count_homqua)}}</b> việc làm được tìm thấy</h4>
                                        </div>
                                        @if($homqua != null)
                                        @foreach($homqua as $vl)
                                        ...
                                        <div class="blog-sidebar">
                                            <div class="sidebar-widget padd-top-0 padd-bot-0">
                                                ...
                                                <ul class="sidebar-list expandible colorgb-job-filter">
                                                    ...
                                                    <li class="t7d ">
                                                        <a title="Việc làm hôm qua" href="{{route('vieclamhomqua')}}" style="color: red">
