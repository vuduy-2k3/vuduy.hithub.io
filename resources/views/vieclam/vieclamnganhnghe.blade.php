                    ...
                    <div class="col-sm-12">
                        <div class="clearfix">
                            <ol class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                                ...
                                <li class="active"><span class="text-muted">Việc làm ngành nghề</span></li>
                            </ol>
                                ...
                                <div class="row extra-mrg job-list brows-employer-list mrg-bot-10">
                                    <div class="col-sm-9">
                                        <div class="sidebar-widget-title mrg-bot-15">
                                            ...
                                            <h4>Có <b style="color: red">{{count($count_vlnganhnghe)}}</b> việc làm được tìm thấy</h4>
                                        </div>
                                        @if($vlnganhnghe != null)
                                        @foreach($vlnganhnghe as $vl)
